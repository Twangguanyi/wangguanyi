...
Route::get('/contents/teacher1', 'Content\ContentController@teacher1');
Route::get('/contents/teacher2', 'Content\ContentController@teacher2');
Route::get('/contents/teacher3', 'Content\ContentController@teacher3');
Route::get('/contents/teacher4', 'Content\ContentController@teacher4');
